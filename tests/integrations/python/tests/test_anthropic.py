...
class TestAnthropicCodeExecution:
    ...
    def test_03_bash_code_execution(self, code_exec_client):
        ...
        if "bash_code_execution" in scan["tool_names"]:
            print("✓ bash_code_execution sub-tool exercised")
        else:
            print(f"⚠ model used {scan['tool_names']} instead of bash; code-exec still valid")
    ...
    def test_04_text_editor_create_view_edit(self, code_exec_client):
        ...
        assert scan["result_types"], f"code execution did not run; got {scan}"
        if "text_editor_code_execution" in scan["tool_names"]:
            ...
            print(f"⚠ model used {scan['tool_names']} instead of text_editor; code-exec still valid")
    ...
    def test_05_text_editor_streaming(self, code_exec_client):
        ...
        if "text_editor_code_execution" in scan["tool_names"]:
            ...
            print(f"⚠ model used {scan['tool_names']} instead of text_editor; stream still well-formed")
